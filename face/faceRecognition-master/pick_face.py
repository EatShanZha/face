...
def readPicSaveFace(sourcePath,objectPath,*suffix):
    try:
        ...
        count = 1
        face_cascade = cv2.CascadeClassifier('D:\python\Lib\site-packages\cv2\data\haarcascade_frontalface_alt.xml')
        ...
        print ('Already read %s Faces to Destination %s '%(str(count-1),objectPath))


if __name__ == '__main__':
     readPicSaveFace('F:\img\huge','F:\img\pan\imgtrain\huge','.jpg','.JPG','png','PNG')
